...
function renderLanding() {
  return `
    ...
    <section class="about-section py-5 min-vh-90 bg-light d-flex align-items-center">
      <div class="container">
        <div class="row align-items-center">
          <!-- Kiri: gambar about -->
